...
// Stage 1 Max Tier 4 Copy (250-500 chars per item)
const STAGE1_TIER4_DATA = [
  {
    slideNumber: 2,
    templateFile: 'Format_1_BulletSOP_T3.html',
    outputFile: 'Slide_2_Format_1_BulletSOP_T4_Stage1.png',
  ...
  },
  {
    ...
    outputFile: 'Slide_3_Format_2_KeyValueTable_T4_Stage1.png',
  ...
  },
  {
    ...
    outputFile: 'Slide_4_Format_3_ArrowFlow_T4_Stage1.png',
  ...
  },
  {
    ...
    outputFile: 'Slide_5_Format_4_QASplit_T4_Stage1.png',
  ...
  },
  {
    ...
    outputFile: 'Slide_6_Format_5_NarrativeBlock_T4_Stage1.png',
...
async function runStage1Tier4() {
  console.log('======================================================');
  console.log('🚀 STAGE 1: TIER 4 STRESS TEST RENDERING (250-500 Chars)');
  console.log('======================================================\n');
  ...
  for (const item of STAGE1_TIER4_DATA) {
    ...
    console.log(`   ✓ Rendered Stage 1 Tier 4 Slide ${item.slideNumber} (${item.templateFile}): ${outputPath}`);
  }

  await browser.close();
  console.log('\n======================================================');
  console.log(`✅ STAGE 1 TIER 4 COMPLETE. Outputs saved to: ${OUTPUT_DIR}`);
  console.log('======================================================\n');
}

runStage1Tier4().catch(err => {
  console.error('❌ Error during Stage 1 Tier 4 rendering:', err);
  process.exit(1);
});
