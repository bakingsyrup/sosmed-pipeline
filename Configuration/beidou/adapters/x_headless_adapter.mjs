  ...
  return page.evaluate((skipIdsArr) => {
    ...
    for (const article of articles) {
      try {
        ...
        const hasImage = Boolean(article.querySelector('[data-testid="tweetPhoto"], [data-testid="tweetPhotoGroup"], [data-testid="tweetImage"]'));
        const hasVideo = Boolean(article.querySelector('[data-testid="videoComponent"], [data-testid="videoPlayer"], video'));
        const hasCard  = Boolean(article.querySelector('[data-testid="card.wrapper"]'));
