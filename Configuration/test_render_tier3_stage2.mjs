...
// Stage 2 Calibrated Tier 3 Copy (140-300+ chars per item)
const STAGE2_TIER3_DATA = [
  {
    slideNumber: 2,
    templateFile: 'Format_1_BulletSOP_T3.html',
    outputFile: 'Slide_2_Format_1_BulletSOP_T3.png',
  ...
  },
  {
    ...
    outputFile: 'Slide_3_Format_2_KeyValueTable_T3.png',
  ...
  },
  {
    ...
    outputFile: 'Slide_4_Format_3_ArrowFlow_T3.png',
  ...
  },
  {
    ...
    outputFile: 'Slide_5_Format_4_QASplit_T3.png',
  ...
  },
  {
    ...
    outputFile: 'Slide_6_Format_5_NarrativeBlock_T3.png',
...
async function runStage2() {
  console.log('======================================================');
  console.log('🚀 STAGE 2: TIER 3 CALIBRATED GALLERY RENDERING');
  console.log('======================================================\n');
  ...
  for (const item of STAGE2_TIER3_DATA) {
    ...
    console.log(`   ✓ Rendered Stage 2 Format ${item.slideNumber - 1}: ${outputPath}`);
  }
...
runStage2().catch(err => {
  console.error('❌ Error during Stage 2 rendering:', err);
  process.exit(1);
});
