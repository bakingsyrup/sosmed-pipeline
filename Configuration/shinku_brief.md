...
* **July 25, 2026**: Upgraded Event News drafting to **4-Draft Angle & Archetype Distribution System** (`x_style_guide.md`, `prompts/drafting_prompt.mjs`). Draft 1 is now forced to **Archetype 1 (Macro Signal, ~70 words)** using a Top 3 Neutral Angle for instant ultra-compact publishing; Drafts 2 & 3 deliver neutral variations with flexible Archetypes; Draft 4 delivers the creative Wildcard variation.
